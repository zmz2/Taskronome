...
For a focused compact-window check without repeating the rotation/integration flow, run `scripts/windows-interactive-acceptance.ps1 -WindowLayoutOnly` against a self-contained publish; it covers the 400×300, 480×360, 640×480, and 1040×720 logical-DIP matrix across all four tabs.
